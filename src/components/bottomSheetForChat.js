...
export default function BottomAttachment({ onClose }) {
  ...
  return (
    <TouchableWithoutFeedback onPress={onClose}>
        <SafeAreaView style={{flex: 1, justifyContent: 'flex-end',}}>
                ...
                <View style={[{height : height * 0.5, justifyContent : 'space-between', backgroundColor: 'white', borderTopLeftRadius: width * 0.08, borderTopRightRadius: width * 0.08, padding: width * 0.05}]}>
                    <View style={{flexDirection : 'row'}}>
                        ...
                        <Text style={[text.medium, {marginLeft : width * 0.2}]}>Attachments</Text>
                    </View>
                    ...
                    <View style={{justifyContent : 'space-evenly', flex : 1}}>
                        <TouchableOpacity  onPress={onClose}>
                            <View style={{flexDirection : 'row', padding : width * 0.01, alignItems : 'center'}}>
                                ...
                                <Text style={[text.medium]}>Camera</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity onPress={onClose}>
                            <View style={{flexDirection : 'row', padding : width * 0.01, alignItems : 'center'}}>
                                <View style={{alignItems : 'center', justifyContent : 'center',width: width * 0.12, height : height * 0.06, borderRadius : width * 0.1,marginRight : width * 0.03,  backgroundColor : colors.primary}}>
                                    <Image source={require('../../assets/icons/icnDocument.png')} style={{width : width * 0.06, height : height * 0.03,tintColor : 'black'}}></Image>
                                </View>
                                <Text style={[text.medium]}>Document</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity onPress={onClose}>
                            <View style={{flexDirection : 'row', padding : width * 0.01, alignItems : 'center'}}>
                                ...
                                <Text style={[text.medium]}>Media</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity onPress={onClose}>
                            <View style={{flexDirection : 'row', padding : width * 0.01, alignItems : 'center'}}>
                                ...
                                <Text style={[text.medium]}>Location</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
